...
import com.example.youtubermanager.youtubeparser.models.videos.Main;
import com.example.youtubermanager.youtubeparser.models.videos.Thumbnails;
import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.example.youtubermanager.youtubeparser.models.videos.High;
import com.example.youtubermanager.youtubeparser.models.videos.Id;
import com.example.youtubermanager.youtubeparser.models.videos.Item;
        ...
        if (result != null) {
            ...
            try {
                ...
                for (int i = 0; i < itemList.size(); i++) {
                    ...
                    tempVideo.setThumbnails(imageLink);
                    tempVideo.setDate(pubDateString);
                    String kind = id.getKind();
                    if(kind.trim().toLowerCase().equals("youtube#video")){
