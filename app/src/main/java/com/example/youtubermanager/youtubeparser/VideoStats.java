...
import com.example.youtubermanager.youtubeparser.models.stats.Item;
import com.example.youtubermanager.youtubeparser.models.stats.Main;
...
public class VideoStats extends AsyncTask<String, Void, String> {
    ...
    public String generateStatsRequest(String videoID, String key) {
        ...
        urlString = urlString + key + "&part=snippet,contentDetails,statistics&id=" + videoID;
        return urlString;
    }
